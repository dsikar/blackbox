...
def decode_point_info_reply( packet_to_decode ) : 
    ...
    print("Packet to decode: ", packet_to_decode)
    # remove checksum from end
    #shorter = packet_to_decode[:length - 3] # only works for 2 digit checksum
    shorter = packet_to_decode[0:packet_to_decode.rfind(',')]
    shorter = packet_to_decode[0:packet_to_decode.rfind(',')]
...
def decode_reply_packet( packet_to_decode ) :
    ...
    length = len( packet_to_decode )
    print("decode packet reply, packet_to_decode", packet_to_decode)

    # shorter = packet_to_decode[:length - 3] # will only work for two-digit checksums
    shorter = packet_to_decode[0:packet_to_decode.rfind(',')]
    shorter = packet_to_decode[0:packet_to_decode.rfind(',')]
